package io.spring.flatWite;

import io.spring.domain.Customer;
import io.spring.domain.CustomerRowMapper;
import lombok.Data;
 ...
 */
//@Configuration
public class FlatFileWriteJobConfiguration {
    @Autowired
    ...
    public Step step1() throws Exception {
        return stepBuilderFactory.get("xmlFileWriteSetp1")
    ...
    public Job job() throws Exception {
        return jobBuilderFactory.get("xmlFileWriteJob")
                .start(step1())
                .build();
    }
